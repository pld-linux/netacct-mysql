...
Netacct-MySQL jest łataną wersją net-acct pracującą z bazą danych
MySQL. Jest to demon monitorujący ruch w sieci dla konkretnych sieci.
Faktycznie pracuje on jak sniffer ustawiając urządzenie w tryb PROMISC
i zczytujący ruch.
